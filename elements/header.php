    ...
    <button
        ...
        <div class="collapse" id="navbar">
            <div class="p-4">
                ...
                <div class="fs-4">
                    <a href="index.php" class="text-white">Works</a>
                </div>
                <div class="fs-4">
                    <a href="index.php#section-happy-clients" class="text-white">Happy Clients</a>
                </div>
                <div class="fs-4">
                    <a href="index.php#professional-team" class="text-white">Our Professional Team</a>
                </div>
                <div class="fs-4">
